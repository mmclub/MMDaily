 ...
 * 显示全息主题的颜色选择器
 * <p>
 * Use  to retrieve the selected color.
 * 用于检索选定的颜色
 * </p>
 */
public class HoloCircleSeekBar extends View {
     ...
     * </p>
     * <p>
     * 我们使用这个View的中心作为内部坐标系的原点，Android使用左上角作为查看View特定坐标系的原点。
     * 所以这个就是我们将它从一个坐标系移动到另外一个坐标系的价值。
     * <p/>
     * </p>
     * <p/>
     * <p>
    ...
    /*
     *这里是使用了Android自定义控件，利用XML定义所需要的属性，然后进行传值。
     * 然后在这个地方获取在XML里填入的值，关于在XML中定义属性不懂的话，请看这里http://blog.csdn.net/nanzhiwen666/article/details/12224489
     * 定义属性的位置在res/values/attrs
    * */
